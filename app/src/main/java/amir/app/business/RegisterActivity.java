                ...
                repository.loginUser(editEmail.getText().toString(),
                        editPassword.getText().toString(), new UserRepository.LoginCallback<Customer>() {
                            ...
                            public void onSuccess(AccessToken token, Customer currentUser) {
                                ...
                                config.setValue(RegisterActivity.this, "token", config.token.id);
                                config.setValue(RegisterActivity.this, "userid", config.token.userId);
                            ...
                            @Override
                            public void onError(Throwable t) {
                                util.alertDialog(RegisterActivity.this, "بستن", "خطا در ارتباط با شبکه", "خطا", new SweetAlertDialog.OnSweetClickListener() {
                                    @Override
