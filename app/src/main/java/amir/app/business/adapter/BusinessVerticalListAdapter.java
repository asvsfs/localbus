...
public class BusinessVerticalListAdapter extends RecyclerView.Adapter<BusinessVerticalListAdapter.ViewHolder> {
    ...
    public BusinessVerticalListAdapter(Context context, List<Businesse> items) {
